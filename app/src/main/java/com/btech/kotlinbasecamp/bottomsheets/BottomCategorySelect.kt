...
class BottomCategorySelect :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listOfData = listOf(
            AppData(R.drawable.subsrciption, "Subscription"),
            AppData(R.drawable.utility, "Utility"),
            AppData(R.drawable.card, "Card Payment"),
            AppData(R.drawable.ic_money_2, "Loan"),
            AppData(R.drawable.rent, "Rent"),
        )
